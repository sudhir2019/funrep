                                ...
                                <td class="subheadings">
                                    <table>
                                        <tbody><tr>
                                            <td>First Name :</td>
                                            <td>
                                                <input name="ctl00$siteDataHolder$txtChildFName" type="text" id="siteDataHolder_txtChildFName" />
                                            </td>
                                            <td>
                                                <span id="siteDataHolder_reqChildFName" style={{color:"red",visibility:"hidden"}}>*</span>
                                            </td>
                                        </tr>
                                            <tr>
                                                <td>Last Name :</td>
                                                <td>
                                                    <input name="ctl00$siteDataHolder$txtChildLName" type="text" id="siteDataHolder_txtChildLName" />
                                                </td>
                                                <td>
                                                    <span id="siteDataHolder_reqChildLName" style={{color:"red",visibility:"hidden"}}>*</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Date Of Birth :</td>
                                                <td colspan="2">
                                                    <table>
                                                        <tbody><tr>
                                                            <td>
                                                                <select name="ctl00$siteDataHolder$drpDOBDate" id="siteDataHolder_drpDOBDate">
                                                            ...
                                                            <td>
                                                                <select name="ctl00$siteDataHolder$drpDOBMonth" id="siteDataHolder_drpDOBMonth">
                                                            ...
                                                            <td>
                                                                <select name="ctl00$siteDataHolder$drpDOBYear" id="siteDataHolder_drpDOBYear">
                                            ...
                                            <tr>
                                                <td>Country :</td>
                                                <td colspan="2">
                                                    <select name="ctl00$siteDataHolder$drpCountry" id="siteDataHolder_drpCountry">
                                                        ...
                                                        <option value="FRENCH SOTHERN TERRITORIES">FRENCH SOTHERN TERRITORIES</option>
                                                        ...
                                                        <option value="MACEDONIA-FORMER YOGOSLAV REPUBLICN">MACEDONIA-FORMER YOGOSLAV REPUBLICN</option>
                                                        ...
                                                        <option value="SAI TOME AND PRINCIPE">SAI TOME AND PRINCIPE</option>
                                            ...
                                            <tr>
                                                <td>State :</td>
                                                <td colspan="2">
                                                    <select name="ctl00$siteDataHolder$drpState" id="siteDataHolder_drpState">
                                            ...
                                            <tr>
                                                <td>City :</td>
                                                <td colspan="2">
                                                    <select name="ctl00$siteDataHolder$drpCity" id="siteDataHolder_drpCity">
                                                        <option value="A">A</option>
                                            ...
                                            <tr>
                                                <td>Pin Code :</td>
                                                <td>
                                                    <input name="ctl00$siteDataHolder$txtChildPin" type="text" maxlength="6" id="siteDataHolder_txtChildPin" />
                                                </td>
                                                <td>
                                                    <span id="siteDataHolder_reqChildPin" style={{color:"red",visibility:"hidden"}}>*</span>
                                                    <span id="siteDataHolder_regChildPin" style={{color:"red",visibility:"hidden"}}>*</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Address :</td>
                                                <td>
                                                    <textarea name="ctl00$siteDataHolder$txtAddress" rows="4" cols="15" id="siteDataHolder_txtAddress"></textarea>
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Phone :</td>
                                                <td>
                                                    <input name="ctl00$siteDataHolder$txtPhone" type="text" maxlength="11" id="siteDataHolder_txtPhone" />
                                                </td>
                                                <td>
                                                    <span id="siteDataHolder_reqPhone" style={{color:"red",visibility:"hidden"}}>*</span>
                                                    <span id="siteDataHolder_regPhone" style={{color:"red",visibility:"hidden"}}>*</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Email ID :</td>
                                                <td>
                                                    <input name="ctl00$siteDataHolder$txtEmail" type="text" id="siteDataHolder_txtEmail" />
                                                </td>
                                                <td>
                                                    <span id="siteDataHolder_reqEmail" style={{color:"red",visibility:"hidden"}}>*</span>
                                                    <span id="siteDataHolder_regEmail" style={{color:"red",visibility:"hidden"}}>*</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Occupation :</td>
                                                <td colspan="2">
                                                    <select name="ctl00$siteDataHolder$drpOccupation" id="siteDataHolder_drpOccupation">
                                            ...
                                            <tr>
                                                <td>Member Type :</td>
                                                <td colspan="2">
                                                    <select name="ctl00$siteDataHolder$drpMemberType" id="siteDataHolder_drpMemberType">
                                                        <option selected="selected" value="A">A</option>

                                                    </select>
                                                </td>
                                                <td>
                                                    <Link id="siteDataHolder_hypLnkTypeDetails" to="/MemType" target="_blank">What's Member Type ?</Link>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Password :</td>
                                                <td>
                                                    <input name="ctl00$siteDataHolder$txtPass" type="password" id="siteDataHolder_txtPass" />
                                                </td>
                                                <td>
                                                    <span id="siteDataHolder_reqPass" style={{color:"red",visibility:"hidden"}}>*</span>
                                                    <span id="siteDataHolder_regPass" style={{color:"red",visibility:"hidden"}}>*</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Confirm Password :</td>
                                                <td>
                                                    <input name="ctl00$siteDataHolder$txtConfirmPass" type="password" id="siteDataHolder_txtConfirmPass" />
                                                </td>
                                                <td>
                                                    <span id="siteDataHolder_reqConPass" style={{color:"red",visibility:"hidden"}}>*</span>
                                                    <span id="siteDataHolder_regConPass" style={{color:"red",visibility:"hidden"}}>*</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <input id="siteDataHolder_chkBoxAgree" type="checkbox" name="ctl00$siteDataHolder$chkBoxAgree" />
                                                </td>
                                                <td>
                                                    Yes I agree to the &nbsp;
                                                    <a id="siteDataHolder_hypLinkAgree" href="Terms.aspx" target="_blank">Terms and Conditions</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                                                    <span id="siteDataHolder_cudValidTerms" style={{color:"red",visibility:"hidden"}}>Please Agree to the Terms and Condition</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                                                    <table>
                                                        <tbody><tr>
                                                            <td>
                                                                <input type="submit" name="ctl00$siteDataHolder$btnChangePass" value="Submit" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ctl00$siteDataHolder$btnChangePass&quot;, &quot;&quot;, true, &quot;ChildRegister&quot;, &quot;&quot;, false, false))" id="siteDataHolder_btnChangePass" />
                                                            </td>
                                                            <td>
                                                                <input type="submit" name="ctl00$siteDataHolder$btnReset" value="Reset" id="siteDataHolder_btnReset" />
                                                            </td>
                                                        </tr>
                                                        </tbody></table>
                                                </td>
